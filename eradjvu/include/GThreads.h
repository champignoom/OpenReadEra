...
class EdBridgeMonitor : public GMonitor
{
public:
    EdBridgeMonitor() : GMonitor("EdBridgeMonitor") { }
};
...
// Хотя IntelliJ показывает, что этот конструктор нигде не используется, но его удаление
// приводит к появлению ошибок декодирования страниц и взаимоблокировкам.
inline
